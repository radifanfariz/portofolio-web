...
const PreviewSlider = ({ imageList }) => {
    return (
        <div className="mx-3">
            <Swiper key={uniqueId} navigation={true} modules={[Navigation]} spaceBetween={-50} slidesPerView={2} className="mySwiper rounded-[100px] border-4">
                {
                        ...
                        images.src.map((item) => {
                            ...
                            return (
                                <SwiperSlide key={uniqueId()}>
                                    <div key={uniqueId()} className='w-[350px] h-[800px] relative ml-10 '>
